<div class="w-full max-w-2xl space-y-8">
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown placeholder="Select a fruit" :options="[
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown label="Country" placeholder="Select your country" :options="[
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown label="Category" placeholder="Select a category" :required="true" :options="[
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown label="Programming Language" placeholder="Search and select..." :searchable="true"
                :options="[
        ['value' => 'php', 'label' => 'PHP'],
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown label="Size" value="md" :options="[
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown label="Status" placeholder="Select status" error="Please select a status" :options="[
    ...
    <div class="space-y-3">
        ...
        <div class="max-w-xs">
            <x-ui.dropdown label="Disabled" placeholder="Cannot select" :disabled="true" :options="[
