    ...
    <div
        ...
        <aside
            ...
            <div class="py-6 pr-6 lg:py-8">
                <h4 class="mb-1 rounded-md px-2 py-1 text-sm font-semibold">{{ config('docs.navigation.getting_started.title') }}</h4>
                <div class="grid grid-flow-row auto-rows-max text-sm">
                    @foreach (config('docs.navigation.getting_started.pages') as $slug => $title)
                ...
                <h4 class="mb-1 mt-8 rounded-md px-2 py-1 text-sm font-semibold">{{ config('docs.navigation.components.title') }}</h4>
                <div class="grid grid-flow-row auto-rows-max text-sm">
                    @foreach (config('docs.navigation.components.items') as $component)
