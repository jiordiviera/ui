<x-layouts.app>
    ...
    <section class="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32 overflow-hidden">
        <div class="container mx-auto flex max-w-[64rem] flex-col items-center gap-4 text-center px-4 relative">
            ...
            <a href="https://github.com/jiordiviera/php-ui/releases" target="_blank">
                <x-ui.badge variant="outline" class="gap-2 py-1.5 px-3 rounded-full hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors">
                    <x-ui.badge variant="primary" size="sm" class="rounded-full px-2 py-0.5 text-[10px] h-auto">New</x-ui.badge>
    ...
    <section class="container mx-auto py-8 md:py-12 lg:py-24 px-4 border-t border-zinc-100 dark:border-zinc-800/50">
                ...
                <ul class="space-y-4 mt-4">
                    <li class="flex items-center gap-3">
                        <div class="rounded-full bg-blue-100 p-1.5 dark:bg-blue-900/30">
                            <x-lucide-check class="h-4 w-4 text-blue-600 dark:text-blue-400" />
                        </div>
                        <span class="text-zinc-700 dark:text-zinc-300 font-medium">You own the code. No vendor lock-in.</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <div class="rounded-full bg-blue-100 p-1.5 dark:bg-blue-900/30">
                            <x-lucide-check class="h-4 w-4 text-blue-600 dark:text-blue-400" />
                        </div>
                        <span class="text-zinc-700 dark:text-zinc-300 font-medium">Styled with Tailwind CSS v4.</span>
                    </li>
                    <li class="flex items-center gap-3">
                        <div class="rounded-full bg-blue-100 p-1.5 dark:bg-blue-900/30">
                            <x-lucide-check class="h-4 w-4 text-blue-600 dark:text-blue-400" />
                        </div>
                        <span class="text-zinc-700 dark:text-zinc-300 font-medium">Fully compatible with Livewire 3.</span>
                    </li>
                </ul>
            </div>
            
            <!-- Fake UI Card -->
            <div class="relative rounded-xl border border-zinc-200 bg-white shadow-2xl dark:border-zinc-800 dark:bg-zinc-950 p-6 md:p-8">
                ...
                <div class="space-y-6">
                    <div class="space-y-2 text-center">
                        ...
                        <p class="text-sm text-zinc-500 dark:text-zinc-400">Enter your email below to create your account</p>
                    </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-xs uppercase">
                            <span class="bg-white px-2 text-zinc-500 dark:bg-zinc-950 dark:text-zinc-400">Or continue with</span>
                        </div>
                    </div>

                    <x-ui.button variant="outline" class="w-full" icon="github">
                        GitHub
                    </x-ui.button>
                </div>
            </div>
    ...
    <section class="container mx-auto py-8 md:py-12 lg:py-24 px-4">
        <div class="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
            ...
            <p class="max-w-[85%] leading-normal text-zinc-500 sm:text-lg sm:leading-7 dark:text-zinc-400">
        ...
        <div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3 mt-12">
            @foreach ($features as $feature)
                <div class="group relative overflow-hidden rounded-lg border border-zinc-200 bg-white p-2 hover:border-zinc-300 transition-all hover:shadow-md dark:border-zinc-800 dark:bg-zinc-950 dark:hover:border-zinc-700">
                    <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
                        <div class="rounded-full w-10 h-10 flex items-center justify-center bg-zinc-100 dark:bg-zinc-900 group-hover:scale-110 transition-transform duration-300 text-zinc-900 dark:text-zinc-50">
                            <x-dynamic-component :component="'lucide-' . $feature['icon']" class="h-5 w-5" />
                        </div>
                        <div class="space-y-2">
                            <h3 class="font-bold">{{ $feature['title'] }}</h3>
                            <p class="text-sm text-zinc-500 dark:text-zinc-400">{{ $feature['description'] }}</p>
                        </div>
                    </div>
                </div>
            @endforeach
    ...
    <section class="container mx-auto py-8 md:py-12 lg:py-24 px-4 text-center">
        ...
        <p class="mx-auto mt-4 max-w-[42rem] text-lg text-zinc-500 dark:text-zinc-400">
        ...
        <div class="mt-8 flex justify-center gap-4">
             ...
             <x-ui.button href="https://github.com/jiordiviera/php-ui" variant="outline" size="lg" icon="github">
                View on GitHub
            </x-ui.button>
        </div>
    </section>
